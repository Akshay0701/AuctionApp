...
public class SellerRegister extends AppCompatActivity {
    ...
    EditText address,country,email,password,phoneNo,sName;
        ...
        gotoLogin.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        startActivity(new Intent(SellerRegister.this, SellerLogin.class));
                    }
                });
        ...
        registerBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!Patterns.EMAIL_ADDRESS.matcher(semail).matches()){
                    ...
                    editor= PreferenceManager.getDefaultSharedPreferences(SellerRegister.this).edit();
                    editor.putString("seller_username", semail.trim());
                    editor.putString("seller_password", spassword.trim());
                    editor.apply();
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            //sucess
                            Toast.makeText(SellerRegister.this, "Registered with "+user.getEmail(), Toast.LENGTH_SHORT).show();

                            startActivity(new Intent(SellerRegister.this, SellerDashBoard.class));
                            finish();
                            ...
                            loading.setVisibility(View.GONE);
                            scrollView.setVisibility(View.VISIBLE);
                            Toast.makeText(SellerRegister.this, "Authentication Failed", Toast.LENGTH_SHORT).show();
                        }
...
//        }
        ...
        String username=prefs.getString("seller_username","");
        String pass=prefs.getString("seller_password","");
                    ...
                    .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                Toast.makeText(SellerRegister.this, "Authentication failed.",
